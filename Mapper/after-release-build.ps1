...
$filesToInclude = $(".\Info.json", ".\bin\Release\net48\Mapper.dll")
$releaseInfo = New-ModRelease -ModName $modName -FilesToInclude $filesToInclude -ReleasePath ".\Releases"
...
Write-Host "Release $($releaseInfo.Version) done!"
